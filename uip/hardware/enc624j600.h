...
#define ENC28J60_Select()   FIO0CLR = CS_ENC  // P0.16
#define ENC28J60_Deselect() FIO0SET = CS_ENC
...
/* untuk board komon thermocouple */
...
/* define yang independen terhadap hardware */
#ifdef  BOARD_KOMON
//#define CS_ENC	BIT(18)
//#define INT_ENC	BIT(17)
...
#ifdef TAMPILAN_LPC
#define CS_ENC	BIT(14)
#define INT_ENC	BIT(9)
