...
//#define AMBIL_PM		// pilih 1 antara AMBIL_PM atau LIHAT_PM
#define LIHAT_PM		// pilih 1 antara AMBIL_PM atau LIHAT_PM	
...
#define configTOTAL_HEAP_SIZE		( ( size_t ) ( 120 * configMINIMAL_STACK_SIZE * 4) )		// ditambahkan untuk set alarmHH dan alarmLL
